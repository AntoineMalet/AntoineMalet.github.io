...
**"Foundry VTT Module"**: Une extension TypeScript / JavaScript pour la plate-forme de jeu de rôle en ligne **Foundry VTT**, automatisant le suivi et la résolution simultanée des confrontations selon le système de règles [*Cogent Roleplay*](https://cogentroleplay.com/).
