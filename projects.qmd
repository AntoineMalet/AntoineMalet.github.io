...
<div class="custom-card">
  ...
  <img src="feather.png" class="custom-card-img" alt="FEAther Logo">
  
  <p class="custom-card-text">Application RShiny pour réaliser des analyses d'enrichissement fonctionnel (notamment ORA/GSEA).</p>
  <p class="custom-card-italic">Supervisé par : Hélène DAUCHEL. Co-développeurs: Maël LOUIS, Lucien PIAT</p>
